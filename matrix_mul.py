...
_lib.sparse_matmul_batch_adaptive_batch_parallel.restype = None
_lib.sparse_matmul_batch_adaptive_batch_parallel.argtypes = [
    ctypes.c_int,
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    ctypes.c_void_p,
...
_lib.sparse_matmul_batch_adaptive.restype = None
_lib.sparse_matmul_batch_adaptive.argtypes = [
    ctypes.c_int,
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    # sparse args
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
...
_lib.sparse_matmul_batch_adaptive_parallel.restype = None
_lib.sparse_matmul_batch_adaptive_parallel.argtypes = [
    ctypes.c_int,
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
    ctypes.c_void_p,
...
def run_batch(cases, method="serial"):
    ...
    use_i32 = method in ("dense_axpy", "dense_axpy_parallel", "blas", "blas_parallel", "adaptive", "adaptive_parallel", "batch_parallel")
    ...
    if method == "outer":
        ...
        _lib.sparse_matmul_batch_adaptive_batch_parallel(
            n,
            ctypes.addressof(all_rows_a),
            ctypes.addressof(all_cols_a),
            ctypes.addressof(all_cols_b),
        ...
        _lib.sparse_matmul_batch_adaptive(
            n,
            ctypes.addressof(all_rows_a),
            ctypes.addressof(all_cols_a),
            ctypes.addressof(all_cols_b),
        ...
        _lib.sparse_matmul_batch_adaptive_parallel(
            n,
            ctypes.addressof(all_rows_a),
            ctypes.addressof(all_cols_a),
            ctypes.addressof(all_cols_b),
